...
class Material extends BaseController
{
	...
	{
		$arr = [
			'FINISH_MATERIAL_CODE'  =>  trim($this->request->getPost('material_code')),
			'SAP_PLANT'             =>  trim($this->request->getPost('sap_plant')),
			'GRADE'                 =>  trim($this->request->getPost('grade')),
			'GSM'                   => $this->request->getPost('gsm'),
			'UOM'                   =>  trim($this->request->getPost('uom')),
			'ITEM_TYPE'             => $this->request->getPost('item_type'),
			'WIDTH'                 => $this->request->getPost('width'),
			'LENGTH'    		    => $this->request->getPost('length'),
			'MR_MATERIAL_CODE'      =>  trim($this->request->getPost('mr_material_code')),
