            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
						...
						<div class="row">	
						    <div class="col-sm-3"> 
							<a href="<?php echo base_url(); ?>MRMaterial/add" class="btn btn-info">Add</a>	
							</div>
						</div> 
									...
									{										
										...
										?>								
											<tr class="gradeX">																					
												...
												<td><a href="<?php echo base_url();?>MRMaterial/view/<?php echo $material[$k]["PP_ID"];?>" class="btn btn-primary"><i class="fa fa-eye"></i></a></td>
												<td><a href="<?php echo base_url();?>MRMaterial/edit/<?php echo $material[$k]["PP_ID"];?>" class="btn btn-warning"><i class="fa fa-pencil"></i></a></td>
											</tr>								
										<?php
											$ctr++;
										}
