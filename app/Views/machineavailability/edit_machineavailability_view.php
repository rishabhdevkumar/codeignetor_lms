...
$from_date = old('FROM_DATE', isset($machine['FROM_DATE']) ? date('Y-m-d', strtotime($machine['FROM_DATE'])) : '');
$to_date   = old('TO_DATE', isset($machine['TO_DATE']) ? date('Y-m-d', strtotime($machine['TO_DATE'])) : '');
